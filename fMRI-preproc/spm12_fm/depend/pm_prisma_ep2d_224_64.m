...
pm_def.FWHM = 10;                    % FWHM of Gaussian filter used to implement
%                                      weighted smoothing of unwrapped maps.
...
pm_def.K_SPACE_TRAVERSAL_BLIP_DIR = 1; % Phase encoding direction:1 = P->A;
%                                        -1 = A->P. +ve k-space = 1, -ve = -1.
pm_def.TOTAL_EPI_READOUT_TIME = 31.36; % Prisma EPI ReadOut time (64*0.49ms)

%% Defaults for Unwarping.
% =========================================================================
pm_def.DO_JACOBIAN_MODULATION = 0; % Do jacobian modulation to adjust for
%                                    compression or stretching, No = 0, Yes = 1
